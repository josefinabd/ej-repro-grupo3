...
# Conclusiones
A partir del ejercicio realizado, se determina un muy alto nivel de reproducibilidad del artículo seleccionado, dado que se logró reproducir la Tabla 16 del *Informe de Principales Resultados* de la ENUT, con una estructura idéntica a la original, aunque con pequeñas variaciones en algunos valores. Respecto a la evaluación realizada antes del análisis reproducible, se concluye que el artículo cumple con los criterios de disponibilidad de datos, documentación y transparencia, pero no cumple con el criterio de disponibilidad de código, lo que dificulta la replicación exacta del análisis realizado. Si bien el *Manual de uso de base de datos* es muy detallado e incluso está equipado de explicaciones para usuarios que desconocen el lenguaje y utilización de softwares de programación, no hay acceso al código específico, lo que hace que sea necesario desarrollar códigos propios con ayuda de Inteligencia Artificial.   
