...
# Conclusiones
A partir del ejercicio realizado, se determina un alto nivel de reproducibilidad del artículo seleccionado, dado que se logró reproducir la Tabla 16 del *Informe de Principales Resultados* de la ENUT, con una estructura idéntica a la original, aunque con pequeñas variaciones en algunos valores. Respecto a la evaluación realizada antes del análisis reproducible, se concluye que el artículo cumple con los criterios de disponibilidad de datos, documentación y transparencia, pero no cumple con el criterio de disponibilidad de código, lo que dificulta la replicación exacta del análisis realizado. Si bien el *Manual de uso de base de datos* es muy detallado e incluso en un inicio está equipado de explicaciones para usuarios que desconocen el lenguaje y utilización de softwares de programación, no hay acceso al código específico, lo que hace que sea necesario desarrollar códigos propios con ayuda de Inteligencia Artificial. Es por ello que, si bien se logra un alto nivel de reproducibilidad, aquello no habría sido logrado sin la utilización de IA ya que no sólo existe ausencia de acceso al código original, sino que la base de datos de ENUT es muy compleja de tratar, y su completa comprensión requiere de una formación profesional en manejo de datos y metodologías cuantitativas. Asimismo, la necesidad de recurrir a la IA surge justamente del desconocimiento para tratar correctamente los datos y llegar así a replicar exactamente el estudio, lo que se traduce en una dificultad adicional para la reproducibilidad. Por lo tanto, si bien se logró una reproducción exitosa de la tabla, el proceso no fue sencillo ni directo, lo que evidencia la importancia de contar con acceso al código original para facilitar la replicación exacta del estudio y aumentar la transparencia y reproducibilidad de la investigación.
