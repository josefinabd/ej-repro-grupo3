...
## Código
A continuación, el código original que se encuentra en el Manual de Uso de Base de Datos. Como se menciona en el análisis, no es un código legible ni completo para el proceso de reproducción. Además, la línea completa es el resultado de la unión de varios bloques por lo que se hizo necesario adaptarlo y desarrollarlo. 
