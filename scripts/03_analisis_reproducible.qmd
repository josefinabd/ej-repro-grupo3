...
```
 ...
 Se crea una base auxiliar que contiene únicamente la identificacion de la persona, en base a si contesto o no el cuestionario, pero sin alterar la base original. 
